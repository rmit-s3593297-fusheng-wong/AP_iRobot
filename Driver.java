...
public class Driver {
	...
	private void selectGame(Game[] games, Athlete[] athletes){
		...
		for(int i=0;i<games.length;i++){
			System.out.println((i+1) + ". " + games[i].getGameID());
		}
	...
	private void displayAllGameResults(Game[] games, Athlete[] athletes){
		for(int i=0;i<games.length;i++){
			//print header
			System.out.println((i+1) + ": " + games[i].getGameID() + " - " + games[i].getGameType());
		}
	}
	...
	private void displayAthletePoints(Game[] games, Athlete[] athletes){
		...
		for(int i=0;i<athletes.length;i++){
			System.out.println((i+1) + ": Athletes Name");
		}
	}
	
	private void displayMenu(){
		System.out.println("Ozlympic Game");
		System.out.println("Current successful predictions: " + predictions);
		System.out.println("===================================");
