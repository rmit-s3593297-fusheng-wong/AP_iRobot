...
public class Ozlympic {
	...
	private static Athlete[] initiateAthletes(){
		...
		athletes[0] = new Cyclist("id","name", 28, "state", 0);
		athletes[1] = new Cyclist("id","name", 28, "state", 0);
		athletes[2] = new Cyclist("id","name", 28, "state", 0);
		athletes[3] = new Swimmer("id","name", 28, "state", 0);
		athletes[4] = new Swimmer("id","name", 28, "state", 0);
		athletes[5] = new Swimmer("id","name", 28, "state", 0);
		athletes[6] = new Sprinter("id","name", 28, "state", 0);
		athletes[7] = new Sprinter("id","name", 28, "state", 0);
		athletes[8] = new Sprinter("id","name", 28, "state", 0);
		athletes[9] = new SuperAthlete("id","name", 28, "state", 0);
		athletes[10] = new SuperAthlete("id","name", 28, "state", 0);
		athletes[11] = new SuperAthlete("id","name", 28, "state", 0);
	...
	private static Official[] initiateOfficials(){
		...
		officials[0] = new Official("id","name", 28, "state");
		officials[1] = new Official("id","name", 28, "state");
		officials[2] = new Official("id","name", 28, "state");
	...
	private static Game[] initiateCompetition(Athlete[] athletes, Official[] officials){
		...
		games[2] = new Game("P01", "Sprinting", officials[0], gameAthletes3);
		games[3] = new Game("C02", "Cycling", officials[0], gameAthletes4);
		games[4] = new Game("S02", "Swimming", officials[0], gameAthletes5);
