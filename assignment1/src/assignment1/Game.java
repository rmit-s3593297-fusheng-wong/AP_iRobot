...
public class Game {
	...
	public int runGame(){
		...
		if(isValid){
			...
			int athletePoints=0;
			//get previous points
			athletePoints = gameAthletes[0].getPoints();
			//add new points
			gameAthletes[0].setPoints(athletePoints + 5); //winner gets 5
			athletePoints = gameAthletes[1].getPoints();
			gameAthletes[1].setPoints(athletePoints + 2); //2nd gets 2
			athletePoints = gameAthletes[2].getPoints();
			gameAthletes[2].setPoints(athletePoints + 1); //3rd gets 1
